...
var_info = pd.read_csv("AddEvInfo_UniformSample_wMRD_NoMC.csv", header = None)
predictions = pd.read_csv("RandomForest_predictions_UniformSample_wMRD_NoMC.csv", header = None)

nhits = var_info.iloc[:,1]
charge = var_info.iloc[:,2]
energy = var_info.iloc[:,29]
...
ax = fig.add_subplot(2,1,1)
# Plot as colored o's, connected
ax.errorbar(edges,bins,yerr=bins3,fmt='o-',color="blue",lw=2,label="correct")
ax.errorbar(edges2,bins2,yerr=bins4,fmt='o-',color="orange",lw=2,label="incorrect")
ax.set_ylabel('#')
leg = ax.legend()
ax = fig.add_subplot(2,1,2)
rat = getRatio(bins2,bins)
...
ax = fig.add_subplot(2,1,1)
# Plot as colored o's, connected
ax.errorbar(edges,bins,yerr=bins3,fmt='o-',color="blue",lw=2,label="correct (e-)")
ax.errorbar(edges2,bins2,yerr=bins4,fmt='o-',color="orange",lw=2,label="incorrect (e-)")
ax.set_ylabel('#')
leg = ax.legend()
ax = fig.add_subplot(2,1,2)
rat = getRatio(bins2,bins)
...
ax = fig.add_subplot(2,1,1)
# Plot as colored o's, connected
ax.errorbar(edges,bins,yerr=bins3,fmt='o-',color="blue",lw=2,label="correct (mu-)")
ax.errorbar(edges2,bins2,yerr=bins4,fmt='o-',color="orange",lw=2,label="incorrect (mu-)")
ax.set_ylabel('#')
leg = ax.legend()
ax = fig.add_subplot(2,1,2)
rat = getRatio(bins2,bins)
